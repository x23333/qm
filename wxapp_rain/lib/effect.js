...
//     // 定时器 来做反复的绘制  不需要外部引用 只要内部实现
//     // clearInterval() 变量前加_ 表示私有
//     this._timer = null
//     this.options = opts || {}
//     this.ctx = ctx // 绘图的句柄
...
//   _init() {
//     let { ctx, width, height } = this  // 快速整合
//     // 在子类的内部可以覆盖父类的方法
//     ctx.setLineWidth(2)
//     ctx.setLineCap('round') //线头圆润
//     let speed = speedFactory * this.h
...
//   }
// }
// class Thunder extends Particle{

// }

// export default (ParticleName = 'rain', ctx, width, height, opts) => {
//   switch (ParticleName) {
//     case 'rain':
